...
{
    public abstract class AIComponentBase : MonoBehaviour, IAIComponent
    {
        ...
        #region Attributes 
        protected IAIManager AIMgr { private set; get; }
        ...
        public void Init(IGameManager gameMgr, IAIManager AIMgr)
        {
            ...
            this.AIMgr = AIMgr; 
            this.factionMgr = AIMgr.FactionMgr;
            this.factionSlot = factionMgr.Slot;

            OnPreInit();

            this.AIMgr.InitComplete += HandleNPCFactionInitComplete;
        }

        /// <summary>
        /// Called when the IAIManager instance first initializes the INPCComponent instance.
        /// </summary>
        protected virtual void OnPreInit() { }

        private void HandleNPCFactionInitComplete(IAIManager AIManager, EventArgs args)
        {
            OnPostInit();
        ...
        /// <summary>
        /// Called after all INPCComponent instances have been cached and initialized by the IAIManager instance.
        /// </summary>
